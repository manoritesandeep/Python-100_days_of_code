...
# window.minsize(height=750, width=750)
...
# Timer title Label
timer_label = Label(text="TIMER", fg=GREEN, font=(FONT_NAME, 45, "bold"), highlightthickness=0, bg=YELLOW)
